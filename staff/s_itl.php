...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['deleteId'])) {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>Swal.fire('Record deleted successfully!', '', 'success');</script>";
    } else {
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr>
                                ...
                                <button type='button' class='action delete-link btn btn-danger btn-sm' data-bs-toggle='modal' data-bs-target='#deleteModal' data-id='" . $row['id'] . "' title='Delete this record'>
